      ...
      def self.init_default_actions(klass)
        klass.class_eval do
          ...
          create do
            ...
            vfails.wants.html { render :action => "new" }
          end
          ...
          update do
            ...
            nochanges.wants.html { redirect_to edit_object_url }
            
            failure.wants.html { render :action => "edit" }
            
            vfails.wants.html { render :action => "edit" }
          end

          destroy do
            flash "Successfully removed!"
            wants.html { redirect_to collection_url }
            failure.wants.html { redirect_to collection_path }
          end
