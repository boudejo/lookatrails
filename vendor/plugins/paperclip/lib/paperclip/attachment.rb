  ...
  class Attachment
    ...
    def self.interpolations
      @interpolations ||= {
        ...
        :basenamewithid => lambda do |attachment,style|
        ...
        :foldername   => lambda{|attachment,style| attachment.instance.to_s('foldername') },
        :document_foldername => lambda{|attachment,style| attachment.instance.type.to_s('foldername') },
        :document_type_foldername => lambda{|attachment,style| attachment.instance.to_s('foldername')+'/'+attachment.instance.type.to_s('foldername') },
