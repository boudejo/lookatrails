    ...
    class ControllerNote < AbstractNote
      ...
      protected
        ...
        def controller_filename
          controller_filename = (@controller.class.to_s == 'ApplicationController') ? 'application' : @controller.class.to_s.underscore
          File.join(File.expand_path(RAILS_ROOT), 'app', 'controllers', "#{controller_filename}.rb").sub('/controllers/controllers/', '/controllers/')
        end
